...
import hello.servlet.web.frontcontroller.v5.MyHandlerAapter;
...
public class ControllerV4HandlerAdapter implements MyHandlerAapter {
    @Override
    ...
    public ModelView handler(HttpServletRequest request, HttpServletResponse response, Object handler) throws ServletException, IOException {
        ...
        HashMap<String, Object> mdoel = new HashMap<>();
